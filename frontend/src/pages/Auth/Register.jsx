...
import loginRegister from "../../assets/stisla/img/login-register.png";
            ...
            axios
                ...
                .catch((error) => {
                    if (!error.response) {
                        MySwal.fire({
                            title: "Failed!",
                            text: "Network Error or Server Down",
                            icon: "error",
                        });
                        return;
                    }
    ...
    return (
        <div className="row">
            <div className="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4 tw-mt-10">
                ...
                <div className="card">
                    <center>
                        <img src={loginRegister} className="tw-rounded-t-xl tw-w-1/2 sm:tw-w-1/3 lg:tw-w-1/4 tw-mb-4 tw-mt-2" alt="logo" />
                    </center>
